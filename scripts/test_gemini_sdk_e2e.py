        ...
        proxy_env.update(
            {
                ...
                "UPSTREAM_OPENAI_API_KEY": "test-openai-key",
                "UPSTREAM_ANTIGRAVITY_BASE_URL": f"http://127.0.0.1:{gemini_port}",
                "UPSTREAM_ANTIGRAVITY_API_KEY": "test-gemini-key",
                "ANTIGRAVITY_MIN_REQUEST_INTERVAL_SECONDS": "0",
                "ANTIGRAVITY_FALLBACK_MODEL": GEMINI_FALLBACK_MODEL,
